...
func (app *application) wrapper(next http.Handler) httprouter.Handle {
...
func (app *application) routes() http.Handler {
	...
	router.POST("/v1/admin/editmovie", app.wrapper(secure.ThenFunc(app.editMovie)))
	//router.HandlerFunc(http.MethodGet, "/v1/admin/deletemovie/:id", app.deleteMovie)
	router.GET("/v1/admin/deletemovie/:id", app.wrapper(secure.ThenFunc(app.deleteMovie)))
